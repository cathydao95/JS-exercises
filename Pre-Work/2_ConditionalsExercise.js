...
function exercise4(varA, varB) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
    if (varA === varB && (typeof(varA) === "string" || typeof(varA) === "number")) {
...
// Some unexpected cases are when 'varA' and 'varB' have equal values, but are not equal data types.
// In this situation, they would not pass the test. In addition, if 'varA' and 'varB' are equal types and values,
// but they are not strings or variables and are booleans, null, undefined, or NaN, they would not pass the test.
